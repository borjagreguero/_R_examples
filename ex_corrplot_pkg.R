# introduction to corrplot package
# https://cran.r-project.org/web/packages/corrplot/vignettes/corrplot-intro.html
# use for> corr matrix, confidence intervals. 
#
...
# Using Different Color Spectrum - colorRampPalette()
...
corrplot(M, order = "hclust", addrect = 2, col = col4(10)) # jet 
